...
sport_car = SportCar(350, 'Желтая', 'Спортивная машина', False)
town_car = TownCar(110, 'Зеленая', 'Городская машиина', False)
work_car = WorkCar(80, 'Оранжевая', 'Рабочая машина', False)
